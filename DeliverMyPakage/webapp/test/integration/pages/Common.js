sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("delvermypackage/app", ".html");
		...
		return Opa5.extend("delvermypackage.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["delvermypackage/localService/mockserver"], function (mockserver) {
